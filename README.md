...
7. This step involves some editing on a couple files. The details can be found [here](http://hadoop.apache.org/docs/r2.6.0/hadoop-project-dist/hadoop-common/SingleCluster.html Hint:search for ```etc/hadoop/core-site.xml```
